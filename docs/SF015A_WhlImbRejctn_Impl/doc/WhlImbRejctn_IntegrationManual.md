...
| 2           | Updated per Design vers. 1.9.0 | Matthew Leser          | 2.0         | 26-Jan-2017 |
...
NOTE: In last update, 6 NVM blocks were replaced with 1 NVM struct
containing each of the previous 6 blocks as an element.
