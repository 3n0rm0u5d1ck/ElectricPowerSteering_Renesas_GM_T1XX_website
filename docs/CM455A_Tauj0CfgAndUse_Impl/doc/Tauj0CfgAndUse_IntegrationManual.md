---
layout: default
title: Tauj0CfgAndUse_IntegrationManual
nav_order: 2
...
|----------|----------------------------------------------|-----------------|
| **Sr. No.** | **Title**                            | **Version**                     |
| 1           | FDD : CM455A_Tauj0CfgAndUse_Design   | See Synergy sub project version |
...
| **Tauj0CfgAndUseInit1** | None                        | RTE (Init)  |

|                        |                             |             |
|------------------------|-----------------------------|-------------|
| **Runnable**           | **Scheduling Requirements** | **Trigger** |
| **Tauj0CfgAndUsePer1** | None                        | RTE (2 ms)  |
