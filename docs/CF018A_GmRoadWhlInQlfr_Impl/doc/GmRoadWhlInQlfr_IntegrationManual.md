---
layout: default
title: GmRoadWhlInQlfr_IntegrationManual
nav_order: 1
...
| 3           | CF018A_GmRoadWhlInQlfr_Design            | See Synergy subproject version |
...
| **GmRoadWhlInQlfrInit1** | None                        | Init        |

|                         |                             |             |
|-------------------------|-----------------------------|-------------|
| **Runnable**            | **Scheduling Requirements** | **Trigger** |
| **GmRoadWhlInQlfrPer1** | None                        | RTE(10ms)   |
