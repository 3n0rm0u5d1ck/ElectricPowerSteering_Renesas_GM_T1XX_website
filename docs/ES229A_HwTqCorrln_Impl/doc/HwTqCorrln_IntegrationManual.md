...
| 2           | Added fault injection in build time config | NS         | 2.0         | 07-Oct-2015 |
...
| \<4\>       | FDD – ES229A_HwCorrln_Design    | See Synergy Subproject version |
...
| **HwTqCorrlnInit1** |                             | RTE_Init    |

|                    |                             |             |
|--------------------|-----------------------------|-------------|
| **Runnable**       | **Scheduling Requirements** | **Trigger** |
| **HwTqCorrlnPer1** | None                        | RTE(2ms)    |
| **HwTqCorrlnPer2** | None                        | RTE(4ms)    |
| **HwTqCorrlnPer3** | None                        | RTE(100ms)  |
