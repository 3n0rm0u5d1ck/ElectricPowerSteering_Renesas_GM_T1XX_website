---
layout: default
title: AssiPahFwl_IntegrationManual
nav_order: 1
...
| Initial version | Sarika Natu | 1.0         | 05-Feb-2016 |
...
| 5           | SF044A_HowDetn_Design                                                                                                                                         | Please refer synergy subproject version |
...
| **AssiPahFwlInit1** | None                        | RTE (Init)  |

|                    |                             |             |
|--------------------|-----------------------------|-------------|
| **Runnable**       | **Scheduling Requirements** | **Trigger** |
| **AssiPahFwlPer1** | None                        | RTE(2ms)    |
...
| **AssiPahFwl_START_SEC_CODE** |              |           |
| **AssiPahFwl_STOP_SEC_CODE**  |              |           |
